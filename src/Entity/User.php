...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    {
        return $this->passkeyPublicKey;
    }

    public function setPasskeyPublicKey(?string $passkeyPublicKey): static
    {
        $this->passkeyPublicKey = $passkeyPublicKey;
        return $this;
    }

    public function getPasskeyCounter(): ?int
    {
        return $this->passkeyCounter;
    }

    public function setPasskeyCounter(?int $passkeyCounter): static
    {
        $this->passkeyCounter = $passkeyCounter;
        return $this;
    }
}
